...
namespace MicroServer.Networking.Web.Mvc.Controllers
{
    ...
    public class ControllerMapping
    {
        ...
        /// Key is "action".
        /// </summary>
        private Dictionary<string, MethodInfo> _actions = new Dictionary<string, MethodInfo>();
        ...
        public Dictionary<string, MethodInfo> Mappings
        {
            get { return _actions; }
        }
        ...
        {
            if (_actions.ContainsKey(actionName.ToLower()))
            {
